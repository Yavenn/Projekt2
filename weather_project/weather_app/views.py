...
def index(request):
    API_KEY = open("C:\\Users\\buffe\\Documents\\Studia\\Podstawy programowania\\Programowanie\\Project1\\weather_project\\API_KEY", "r").read()
...
def fetch_weather_and_forecast(city, api_key, current_weather_url, forecast_weather_url):
    ...
    forecast_response = requests.get(forecast_weather_url.format(lon, lat, api_key)).json()
    ...
    return weather_data, daily_forecasts  # Correct indentation of the return statement
